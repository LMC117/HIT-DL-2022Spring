...
from transform import RandomResize, RandomCrop, RandomHorizontalFlip, RandomVerticalFlip, ToTensor, Normalize, Compose
...
def main(args):
    ...
    train_dataset = DriveDataset(args.data_path,
                                 train=True, transforms=T.ToTensor())

    val_dataset = DriveDataset(args.data_path,
                               train=False, transforms=T.ToTensor())
...
def parse_args():
    ...
    parser.add_argument("--data-path", default="../../datasets/", help="DRIVE root")
    # exclude background
